<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <span class="text-gray-500 text-sm font-medium">Nuevo</span>
        </div>
    ...
    <div class="max-w-xl mx-auto">
        <form action="{{ route('responsables.store') }}" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            @csrf
            
            <div class="space-y-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Nombre Completo <span class="text-red-500">*</span></label>
                    <input type="text" name="nombre" value="{{ old('nombre') }}" class="w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500 px-4 py-2.5" required autofocus>
                </div>
                
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Especialidad (Opcional)</label>
                    <input type="text" list="especialidades" name="especialidad" value="{{ old('especialidad') }}" placeholder="Ej. Abogado, Ingeniero..." class="w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500 px-4 py-2.5">
                ...
                <div>
                    ...
                    <input type="email" name="correo" value="{{ old('correo') }}" class="w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500 px-4 py-2.5" required>
                </div>
